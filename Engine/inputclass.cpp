...
bool InputClass::IsF1Pressed() {
	// Do a bitwise and on the keyboard state to check if the F1 key is currently being pressed.
...
bool InputClass::IsF2Pressed() {
	// Do a bitwise and on the keyboard state to check if the F2 key is currently being pressed.
