...
bool BumpModelClass::Initialize(ID3D11Device* device, char* modelFilename, WCHAR* textureFilename) {
	return NULL;
}
...
void BumpModelClass::ReleaseTexture()
{
...
ID3D11ShaderResourceView* BumpModelClass::GetTexture()
{
	return NULL;
}
...
//Needs to be fixed
/*
XMMATRIX BumpModelClass::GetScale() {
	XMMATRIX dummy;
	return dummy;
}
*/
